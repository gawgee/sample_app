# user_spec.rb
# 03-21-11 added password validations
#
require 'spec_helper'
...
describe User do
  ...
  it "should reject invalid email addresses" do
    addresses = %w[fool@foo,com andy_at.org example@foo.]
    addresses.each do |address|
  ...
  end # end of password validations block
  ...
  end # end of password encryption block
  ...
  end # end of authenticate method block
  ...
  describe "micropost associations" do # {
    ...
    describe "status feed" do
      ...
      it "should include the user's miroposts" do

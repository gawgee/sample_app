...
describe UsersController do
  ...
  describe "POST 'create'" do   # {
    describe "failure" do # { failure test block
    ...
    end # } end of successfully creating user

  end  # } endof create block
  ...
  describe "PUT 'update'" do # {
    ...
    end # } end of PUT update failure block
  ...
  describe "authentication of edit/update pages" do  #{
    ...
    describe "for non-signed-in uses" do
  ...
  end # } end of authenication edit/update pages
  ...
  describe "DELETE 'destroy'" do # {
    ...
    describe "as a non-signed-in user" do
      it "should deny access when not signed-in" do
